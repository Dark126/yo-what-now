        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-spice-200 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#home" className="text-spice-200 hover:text-white transition-colors">Home</a>
              </li>
              <li>
                <a href="#products" className="text-spice-200 hover:text-white transition-colors">Products</a>
              </li>
              <li>
                <a href="#packaging" className="text-spice-200 hover:text-white transition-colors">Packaging</a>
              </li>
              <li>
                <a href="#contact" className="text-spice-200 hover:text-white transition-colors">Contact</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#products" className="text-spice-200 hover:text-white transition-colors">Fennel Seeds</a>
              </li>
            </ul>
          </div>
