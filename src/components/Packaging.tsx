...
const Packaging = () => {
  ...
  const [selectedPackaging, setSelectedPackaging] = useState<string>(products[0].packagingOptions[0].id);
  ...
  return (
    <section id="packaging" className="section bg-gradient-to-b from-spice-50 to-white relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
        <motion.div 
          className="absolute top-[30%] left-[15%] w-40 h-40 rounded-full bg-amber-200 opacity-40 blur-3xl"
          animate={{ 
            y: [0, 20, 0],
            scale: [1, 1.05, 1],
          }}
        ...
        />
        <motion.div 
          className="absolute bottom-[20%] right-[10%] w-60 h-60 rounded-full bg-spice-200 opacity-40 blur-3xl"
          animate={{ 
            y: [0, -30, 0],
            scale: [1, 1.1, 1],
          }}
      ...
      <div className="spice-container relative z-10">
        ...
        <motion.p 
          className="text-lg text-gray-700 max-w-3xl mb-10 text-center mx-auto"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-6 md:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">Select Packaging</label>
              ...
              <div className="space-y-4 mt-6">
                <h3 className="text-lg font-semibold text-spice-700">Features:</h3>
                <ul className="space-y-2">
                  {selectedPackaging.includes("kg") ? (
                    <>
                      <li className="flex items-start gap-2">
                        <Check size={18} className="text-leaf-500 mt-0.5 flex-shrink-0" />
          ...
          <div className="mt-8 text-center">
            <Button className="bg-gradient-to-r from-amber-500 to-spice-600 hover:from-amber-600 hover:to-spice-700 text-white">
